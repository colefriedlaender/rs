...
import stylesCss from 'themes/reservationsystem/styles.css?inline';
...
import vaadinButtonCss from 'themes/reservationsystem/components/vaadin-button.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_reservationsystem_componentCss']) {
    registerStyles(
      'vaadin-button',
      unsafeCSS(vaadinButtonCss.toString())
    );
    
    document['_vaadintheme_reservationsystem_componentCss'] = true;
  }
